...
variable "vm_name" {
  description = "Name of the Job Service VM."
  type        = string
  default     = "vm-assms-job-production"
}
variable "vm_size" {
...
variable "nsg_name" {
  ...
  type        = string
  default     = "nsg-assms-job-production"
}
variable "nic_name" {
  description = "Name of the service NIC."
  type        = string
  default     = "nic-assms-job-production"
}
variable "public_ip_name" {
  description = "Name of the optional service public IP."
  type        = string
  default     = "pip-assms-job-production"
}
